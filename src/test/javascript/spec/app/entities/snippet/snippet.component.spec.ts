...
import { SnippetComponent } from 'app/entities/snippet/snippet.component';
import { SnippetService } from 'app/entities/snippet/snippet.service';
import { Snippet } from 'app/shared/model/snippet.model';

describe('Component Tests', () => {
  describe('Snippet Management Component', () => {
    let comp: SnippetComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SnippetComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.snippets && comp.snippets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
